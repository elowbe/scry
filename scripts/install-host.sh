...
if command -v apt-get >/dev/null 2>&1; then
  ...
  "${privilege[@]}" apt-get install -y ffmpeg python3 python3-dev libgirepository1.0-dev libcairo2-dev build-essential pkg-config python3-gi gir1.2-gtk-3.0 gir1.2-ayatanaappindicator3-0.1 gir1.2-gstreamer-1.0 gstreamer1.0-pipewire gstreamer1.0-plugins-base gstreamer1.0-plugins-good xdg-desktop-portal libvulkan1
elif command -v dnf >/dev/null 2>&1; then
  "${privilege[@]}" dnf install -y ffmpeg-free python3 python3-devel gobject-introspection-devel cairo-devel gcc pkgconf-pkg-config python3-gobject gtk3 libappindicator-gtk3 gstreamer1-plugins-base gstreamer1-plugins-good pipewire-gstreamer xdg-desktop-portal vulkan-loader
  ...
  "${privilege[@]}" zypper --non-interactive install ffmpeg python3 python3-devel gobject-introspection-devel cairo-devel gcc python3-gobject typelib-1_0-Gtk-3_0 libappindicator3-1 gstreamer-plugins-base gstreamer-plugins-good gstreamer-plugin-pipewire xdg-desktop-portal libvulkan1
else
